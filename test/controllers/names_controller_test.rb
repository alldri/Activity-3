...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { address: @name.address, email_address: @name.email_address, float: @name.float, price: @name.price, seat_id_seq: @name.seat_id_seq, string: @name.string } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { address: @name.address, email_address: @name.email_address, float: @name.float, price: @name.price, seat_id_seq: @name.seat_id_seq, string: @name.string } }
